 ...
 *
 * <ul>
 *   <li>Successful creation of a PDF when given a non-empty list of equations.
 *   <li>Validation that an empty list triggers an {@link IllegalArgumentException}.
 * </ul>
 * <p>
...
class PdfServiceTests {
	...
	void generatePdfWithNoEquations() {
		...
		Assertions.assertThrows(
				IllegalArgumentException.class, () -> pdfService.generatePdf(emptyList, 1));
	}
}
