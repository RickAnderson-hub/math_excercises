...
public class PdfService {
  ...
  public PdfService(Random random) {
    this.random = random;
  }
                              ...
                              eq ->
                                  IoUtils.safeIo(
                                      () -> {
                                        ...
                                        var tokens =
                                            PdfRenderSupport.formatTokens(eq, placeholderIndex);
  ...
  private void renderEquationLine(
      PDPageContentStream contentStream, PDFont font, List<String> tokens) {
